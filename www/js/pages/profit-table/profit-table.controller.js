...
(function() {
    ...
    ProfitTable.$inject = ['$scope', '$state', 'languageService', 'profitTableService', 'accountService', 'websocketService', '$timeout', '$filter', 'appStateService'];

    function ProfitTable($scope, $state, languageService, profitTableService, accountService, websocketService, $timeout, $filter, appStateService) {
        var vm = this;
        vm.data = {};
        vm.itemsPerPage = 10;
        ...
        vm.sendProfitTableRequest = function() {
          vm.profitTableSet = true;
              ...
              "date_from": vm.data.dateFrom,
              "date_to": vm.data.dateTo
            }
      ...
      vm.setDefaults();
        ...
        $scope.$watch("vm.data.currentPage", function(newValue, oldValue) {
        ...
        $scope.$watch("vm.data.appID", function() {
          profitTableService.update(vm.data);
        });

        $scope.$watch("vm.data.dateType", function() {
          vm.data.currentPage = 0;
          vm.transactions = [];
